...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/** Flag that indicates whether this context is currently active[标记该上下文是否为当前活动的标志] */
	...
	protected void prepareRefresh() {
		...
		// Validate that all properties marked as required are resolvable[验证所标记的所有属性都是可解析的]
	...
	/**
	 * Tell the subclass to refresh the internal bean factory.[子类来刷新内部bean工厂。]

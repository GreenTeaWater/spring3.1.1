...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	/**
	 * Loads the bean definitions via an XmlBeanDefinitionReader.通过XmlBeanDefinitionReader装载beanDefinitions
	 * @see org.springframework.beans.factory.xml.XmlBeanDefinitionReader
	...
	protected void loadBeanDefinitions(DefaultListableBeanFactory beanFactory) throws BeansException, IOException {
		// Create a new XmlBeanDefinitionReader for the given BeanFactory.[创造了一个新的BeanFactory XmlBeanDefinitionReader。]
		...
		initBeanDefinitionReader(beanDefinitionReader);//空的
		loadBeanDefinitions(beanDefinitionReader);//************************
	}

	/**
	 * 初始化用于加载此上下文bean定义的bean定义读取器。默认实现是空的。可插拨的
